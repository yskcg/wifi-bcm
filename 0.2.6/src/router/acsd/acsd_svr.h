 ...
 *
 * $Id: acsd_svr.h 241396 2011-02-18 03:39:46Z stakita $
 */
...
#define ACS_POLICY_LEGACY 		0
#define ACS_POLICY_INTF			1
#define ACS_POLICY_INTF_BUSY	2
#define ACS_POLICY_OPTIMIZED	3
#define ACS_POLICY_CUSTOMIZED1	4
#define ACS_POLICY_CUSTOMIZED2	5
#define ACS_POLICY_USER			6
...
extern int dcs_handle_request(char* ifname, wl_bcmdcs_data_t *dcs_data);
