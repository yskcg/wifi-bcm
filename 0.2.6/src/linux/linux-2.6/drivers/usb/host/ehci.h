...
#define	DEFAULT_I_TDPS		1024		/* some HCs can do less */
	...
	int			qtdc_pid;
	int			qtdc_vid;
	struct usb_device	*qtdc_dev;	/* matched qtdc dev pointer */
...
#define	QH_STATE_DETACHED	6		/* detached for optimization */
...
#define NO_FRAME ((unsigned short)~0)			/* pick new start */
	...
	struct ehci_qtd		*first_qtd; 	/* optimized equivalent of the qtd_list */
} __attribute__ ((aligned (32)));
